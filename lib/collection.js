...
/**
 * Create a collections whose methods always return a promise. You can pass a mongo collection or a mongo database
 * and the name of the collection, and the model for the inserts/updates
 */
var Collection = function () {
    if (arguments.length === 1) {
        ...
        if (typeof arguments[1] === 'string') {
            this.col = arguments[0].collection(arguments[1]);
        } else {
            this.col = arguments[0];
        ...
        throw 'Collections are built passing a collection or a database and the name of the collection and an optional model';
    }
    this.sort = {};
};
    ...
    for (var key in model) {
        ...
        if (key in doc) {
            ...
            if (typeof doc[key] === 'object') {
                if (!this._validateModel(model[key].model, doc[key], insert)) {
                    return false;
                }
            }
        }
...
Collection.prototype.validate = function (doc, insert, id) {
    if (this.validateModel(doc, insert)) {
